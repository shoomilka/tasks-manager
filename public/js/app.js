...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchTasks: function fetchTasks(page_url) {
      ...
      var vm = this;
      fetch(page_url).then(function (responce) {
        return responce.json();
      }).then(function (responce) {
        _this.tasks = responce.data;
        var pagination = {
...
__webpack_require__(/*! C:\www\tasks-manager\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\www\tasks-manager\resources\sass\app.scss */"./resources/sass/app.scss");
